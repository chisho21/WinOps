#
# Module manifest for module 'WinOps'
#
...
@{
    ...
    GUID = 'a9f05cfb-bda1-4413-a928-4e93fa5ec1ef'
    ...
    FormatsToProcess = @('WinOps.ps1xml')
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://github.com/chisho21/WinOps'
    ...
    HelpInfoURI = 'https://github.com/chisho21/WinOps/help'
